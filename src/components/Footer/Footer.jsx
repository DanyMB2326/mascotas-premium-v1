...
const useIsOpen = () =>
  useMemo(() => {
    ...
    const day  = cdmx.getDay();          // 0=Dom … 6=Sáb
    const time = cdmx.getHours() + cdmx.getMinutes() / 60;
    return day >= 1 && day <= 6 && time >= 9 && time < 19;
  }, []);
        ...
        <div className="container footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-map-hint">
              <span className={`footer-open-badge ${isOpen ? '' : 'footer-open-badge--closed'}`}>
